...
class HomePage(BasePage):
    ...
    def ClickTuijian(self):
        self.click_element(loc=HomeLocators.tuijian)

    def LongClickTuijian(self):
        self.long_click_element(loc=HomeLocators.tuijian,duration=3)

    def Swipehome(self):
        self.swipe(loc=HomeLocators.tuijianpage,direction='up', duration=3)
